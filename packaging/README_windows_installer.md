...
|-----|--------|-----------|------------|------|
| `windows-installer` | `windows-2022` | Visual Studio 2022 x64 | `labelprint-v1.2.6-windows-x64-vs2022-win7.zip` | `LISWorkbench-Setup-<version>-win7-win11.exe` |

CI 会从 LabelPrint GitHub Release 下载 `v1.2.6` 的 Win7 兼容包，通过 `build_main.ps1 -LabelPrintPackagePath` 传给 CMake，再用 `packaging/LISWorkbench.nsi` 打包。产物可从 Actions 页面下载 Artifacts。
...
.\scripts\build_main.ps1 -Clean -Config Release -LabelPrintPackagePath "C:\Deps\LabelPrint\labelprint-v1.2.6-windows-x64-vs2022-win7"
...
```powershell
.\scripts\build_main.ps1 -Clean -Config Release -Generator "Visual Studio 18 2026" -LabelPrintPackagePath "C:\Deps\LabelPrint\labelprint-v1.2.6-windows-x64-vs2026"
```
...
```powershell
.\scripts\build_main.ps1 -Clean -Config Release -CMakeArgs "-DCMAKE_PREFIX_PATH=C:\Deps\LabelPrint\labelprint-v1.2.6-windows-x64-vs2022-win7","-DLIS_LABELPRINT_DIR=C:\src\LabelPrint"
```
