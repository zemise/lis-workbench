...
```powershell
.\scripts\build_main.ps1 -Clean -Config Release -Generator "Visual Studio 18 2026" -LabelPrintPackagePath "C:\Deps\LabelPrint\labelprint-v1.2.0-windows-x64-vs2026"
```
...
```powershell
.\scripts\build_main.ps1 -Clean -Config Release -CMakeArgs "-DCMAKE_PREFIX_PATH=C:\Deps\LabelPrint\labelprint-v1.2.0-windows-x64-vs2022-win7","-DLIS_LABELPRINT_DIR=C:\src\LabelPrint"
```
