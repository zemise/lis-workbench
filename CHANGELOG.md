...
- **LabelPrint 跟进**：GitHub Actions 和打包文档改为引用 LabelPrint `v1.2.2` release 包，继续跟进 XP-360B 条码布局和文本居中修正。
- 版本号 v2026.05.21。
